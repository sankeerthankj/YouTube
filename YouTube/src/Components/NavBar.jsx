    ...
    <>
      <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10">
        ...
        <div className="h-10 flex flex-row items-center">
          <div className="w-[593px] bg-yt-black flex border border-yt-light-black items-center first:rounded-3xl h-10">
            <input
              type="text"
              placeholder="Search"
        ...
        <div className="flex items-center justify-center">
          <div className="flex flex-row items-center">
            ...
            <div className="mx-3 items-center cursor-pointer">
              {!user ? (
                <button
                  className="text-yt-white py-1 px-4 bg-yt-red rounded-full font-semibold"
                  onClick={handleLogin}
                >
                  Sign in
                </button>
